"""Create hero image for Jitsi Meet Server article - direct approach."""
import os, sys
...
accent = (33, 150, 243)  # Blue = Webhosting

img = Image.new('RGB', (1216, 640), (26, 26, 46))
draw = ImageDraw.Draw(img)

# Accent strips in blue
for i in range(6):
...
print(f"DONE: {filename} ({sz // 1024} KB) saved to {path}")
sys.exit(0)